...
public class WhileLoop_Demo1 {
    /*  ++++++++++++++++++++++ While Loop ++++++++++++++++++++++
        o While loop เป็นลูปที่วนรอบก็ต่อเมื่อ 'เงื่อนไขที่กำหนดเป็นจริง'
        Syntax :
        +---------------------------+  
        |   while (Condition){      |
        |       Statement;          |
    ...
    */
    public static void main(String[] args) {
        ...
        /* o สร้าง while loop เพื่อวนรอบเข้าถึงสมาชิกทุกตัวในอาเรย์ int_arr โดย
           ...
           o index < int_arr.length หมายถึง จะเป็นจริงเมื่อ 'ค่าของ index น้อยกว่าขนาดของอาเรย์ int_arr' */
